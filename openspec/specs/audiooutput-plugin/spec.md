...
The `AudioOutput` plugin is a Thunder service registered under the callsign `org.rdk.AudioOutput`. It is the canonical place for audio output related capabilities exposed to Firebolt clients.
...
- plugin/CMakeLists.txt:
    - `ThunderAudioOutput` target
    - `ThunderAudioOutputImplementation` target
